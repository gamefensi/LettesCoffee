...
export const Coffee = [
  ...
  },
  {
    ...
    name: 'La Paz', 	
    country: 'Honduras',
    info: `La Paz is customized by Bon Cafe in San Pedro Sula. They've partnered with several small producers from Marcala, within the region of La Paz. Marcala is known for its coffee, and 'Cafe de Marcala' was the first protected origin denomination for coffee in Honduras. Bon Cafe's regional blend embodies the heart and soul of the La Paz region. `,
    pic: `${coffeeBag}`,
    flavor_profile: `${flavProf}`,
    type: 'Regular',
    price12: 14,
